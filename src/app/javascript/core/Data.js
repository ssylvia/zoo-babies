  ...
  var configOptions = {
    ...
    animals: {
      ...
      'crocs': {
        ...
        'status': 'Add Red List Status',
        'name': 'Add name here',
        'zooText': 'On July 6th, 2012, the National Zoo’s 55-year-old Cuban crocodile (<a href="http://nationalzoo.si.edu/animals/reptilesamphibians/facts/factsheets/cubancrocodile.cfm" target="_blank">Crocodylus rhombifer</a>) named Dorothy surprised zookeepers when one of the 26 eggs she’d laid hatched—and then another hatched a week later. This marked the first Cuban crocodile birth at the Zoo since 1988.',
