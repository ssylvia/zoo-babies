  ...
  var configOptions = {
    ...
    animals: {
      'lion': {
        ...
        'wildText': 'As the “world’s most social felines,” African lions (<a href="http://animaldiversity.ummz.umich.edu/accounts/Panthera_leo/" target="_blank">Panthera leo</a>) are unique among big cats in that they have a complex pride social structure. The International Union for the Conservation of Nature (IUCN) lists them as vulnerable. Lion populations have decreased by about 30 percent over the last 20 years.',
      ...
      'greySeal': {
        ...
        'wildText': 'In the wild, gray seals (<a href="http://www.nmfs.noaa.gov/pr/species/mammals/pinnipeds/grayseal.htm" target="_blank">Halichoerus grypus</a>) were once endangered, though they are now a conservation success story, with numbers increasing in most coastal areas of the United States and Canada.',
      ...
      'panda': {
        ...
        'wildText': 'About 1,600 giant pandas (<a href="http://nationalzoo.si.edu/Animals/GiantPandas/PandaFacts/" target="_blank">Ailuropoda melanoleuca</a>) persist in the temperate mountain forests of China, their natural habitat, and the IUCN classifies these majestic animals as <a href="http://www.iucnredlist.org/details/712/0" target="_blank">endangered</a>. Despite intensive conservation efforts, the number of wild pandas continues to decline.',
      ...
      'tiger': {
        ...
        'wildText': 'Scientists estimate that only 400 of this critically endangered species (Panthera tigris ssp. Sumatrae) remain in the wild. Although tigers are legally protected in Sumatra, poaching continues to take a toll, as does a steadily shrinking forest habitat.',
      ...
      'crocs': {
        ...
        'name': 'Add name here',
        'zooText': 'The National Zoo’s 10-year-old lioness Naba gave birth to <a href"http://nationalzoo.si.edu/Animals/GreatCats/Lion/default.cfm" target="_blank">three cubs</a>, two survived and one stillborn, on January 24, 2014. Then on March 4, Naba’s sister, 9-year old lioness, Shera, gave birth to four cubs. Each mom bonds with their cubs for several weeks before they meet their dad—an effort to emulate the time it takes for a lioness to introduce her cubs to their pride in the wild. Naba’s cubs will be on exhibit starting in the early spring.'
        'wildText': 'As the “world’s most social felines,” African lions (Panthera leo) are unique among big cats in that they have a complex pride social structure. The International Union for the Conservation of Nature (IUCN) lists them as vulnerable. Lion populations have decreased by about 30 percent over the last 20 years.'
      ...
      'anemones': {
        ...
        'status': 'Add Red List Status',
        'name': 'Add name here',
        'zooText': 'In August 2010, invertebrate animal keepers successfully bred <a href="http://nationalzoo.si.edu/Animals/Invertebrates/News/anemones.cfm" target="_blank">two species of Urticina anemone</a> or Tealia red anemones, using a technique typically used to breed coral. After two anemones spawned that year, keepers collected the sperm and eggs from the large tank that the anemones inhabit. Placing them in a smaller tank to encourage fertilization, the keepers took the larvae and stirred them in a circular tank until they could swim, and then released them into larger aquarium environments. At the time, it was the first successful breeding of anemones in captivity using this technique. ',
        'wildText': 'The conservation status of Tealia red anemones is not well understood; IUCN has not given it a status on its Red List of threatened species. Scientists are concerned about the vulnerability of many marine animals due to pollution and changes in ocean chemistry caused by climate change.',
